...
This is the same [interface problem that plagues every screen-based tool](/blog/voice-technology-service-bay) in the service bay. Techs work with their hands. Any tool that requires them to stop using their hands is fighting against the fundamental nature of the job.
...
![TenthGear MPI summary showing findings and voice notes](/blog-assets/4-mpi-completion-rate-revenue/mpi-summary.png)
...
If you want to see what voice-first MPI looks like on your shop floor and run the revenue math with your actual numbers, [book a demo](/book-demo). We will walk through it in 15 minutes.
